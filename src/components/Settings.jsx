  ...
  return (
    <div style={{ width: "100%", padding: "20px" }}>
      ...
      <div style={{ marginTop: "20px" }}>
        ...
        {tab === 5 && <MatchPreferenceSettings />}
        {tab === 6 && <SupportSettings />}
      </div>
    </div>
  );
}
...
const MatchPreferenceSettings = () => (
  <Card>
    <CardContent>
      ...
      <TextField label="Preferred Age Range" fullWidth margin="normal" />
      <TextField label="Preferred City/State" fullWidth margin="normal" />
      <TextField label="Religion / Caste" fullWidth margin="normal" />
